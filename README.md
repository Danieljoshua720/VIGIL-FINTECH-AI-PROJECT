...
**The Fintech Platform That Never Sleeps.**
...
Open-source, AI-powered financial operations platform. Risk scanning, autonomous agents, incident response, compliance tracking, and MCP server — all in a single Express.js process.
...
- **20 Autonomous Agents** — Run parallel fraud detection campaigns with scheduling
...
### Agents & Campaigns
- **20 Built-in Agents** — From risk scanning to compliance auditing
...
- **Policy Editor** — Fintech policy CRUD with enforcement rules
...
| Fintech Agents | ![Security Agents](public/img/SecurityAgents.png) |
| Campaigns | ![Campaigns](public/img/Campaigns.png) |
| Findings | ![Findings](public/img/Findings.png) |
| Fraud Feed | ![Threat Feed](public/img/threatfeed.png) |
| Fraud Hunt | ![Threat Hunt](public/img/ThreatHunt.png) |
| OSINT | ![OSINT](public/img/OSINT.png) |
| Attack Timeline | ![Attack Timeline](public/img/AttackTimeline.png) |
| Risk Triage | ![Alert Triage](public/img/AlertTriage.png) |
